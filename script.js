...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const images = [
    ...
    { part: '284bbe09d2c5c8dd3c1c7', description: 'Paths of Glory' },
    ...
    { part: '65a685fc278a970a675cc', description: 'Harry Potter 4: the Goblet of Fire' },
    ...
    { part: '6d100513de6b962a0af10', description: 'Harry Potter 5: the Order of the Phoenix' },
    { part: '6d529cb1bb3a7ea1045aa', description: 'Vertigo' },
    { part: '6ef3b3f8efcfbc13ee406', description: 'Boss Level' },
    { part: '703b51f7719af636289b4', description: 'All Quiet on the Western Front' },
    ...
    { part: 'cef56eec1d0e7583d4a37', description: 'Harry Potter 3: the Prisoner of Azkaban' },
